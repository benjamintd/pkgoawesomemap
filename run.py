...
def api_req(service, api_endpoint, access_token, *args, **kwargs):
    p_req = pokemon_pb.RequestEnvelop()
    ...
    p_ret = pokemon_pb.ResponseEnvelop()
...
def get_heartbeat(service,
                  ...
                  access_token,
                  response, ):
    m4 = pokemon_pb.RequestEnvelop.Requests()
    m = pokemon_pb.RequestEnvelop.MessageSingleInt()
    m.f1 = int(time.time() * 1000)
    m4.message = m.SerializeToString()
    m5 = pokemon_pb.RequestEnvelop.Requests()
    m = pokemon_pb.RequestEnvelop.MessageSingleString()
    m.bytes = '05daf51635c82611d1aac95c0b051d3ec088a930'
    m5.message = m.SerializeToString()
    walk = sorted(getNeighbors())
    m1 = pokemon_pb.RequestEnvelop.Requests()
    m1.type = 106
    m = pokemon_pb.RequestEnvelop.MessageQuad()
    ...
    response = get_profile(service,
                           ...
                           response.unknown7,
                           m1,
                           pokemon_pb.RequestEnvelop.Requests(),
                           m4,
                           pokemon_pb.RequestEnvelop.Requests(),
                           m5, )
    ...
    heartbeat = pokemon_pb.ResponseEnvelop.HeartbeatPayload()
...
def login(args):
    ...
    profile = pokemon_pb.ResponseEnvelop.ProfilePayload()
...
def register_background_thread(initial_registration=False):
    ...
    if initial_registration:
        ...
        search_thread = threading.Timer(2, main)  # delay, in seconds
...
def fullmap():
    ...
    return render_template(
        'index.html', key=GOOGLEMAPS_KEY, fullmap=get_map(), auto_refresh=auto_refresh)
